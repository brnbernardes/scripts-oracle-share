...
--
--  DESCRIPTION
--    Gera um script para testar uma instrução SQL
--
--  HISTORY
--    13/06/2017 => Valter J. de Aquino
--
-----------------------------------------------------------------------------
...
select 'SELECT sql_id, child_number FROM v$sql WHERE sql_text LIKE ''%test &sql_id%'' AND sql_text NOT LIKE ''%v$sql%'';' from dual;
